...
Copy
    ...
    result = agent.invoke({
        "messages": [{"role": "user", "content": "Extract contact info from: John Doe, [[email protected]](/cdn-cgi/l/email-protection), (555) 123-4567"}]
    })

    result["structured_response"]
    # ContactInfo(name='John Doe', email='[[email protected]](/cdn-cgi/l/email-protection)', phone='(555) 123-4567')
