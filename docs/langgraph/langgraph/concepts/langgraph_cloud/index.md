...
This section is only relevant for the cloud-managed LangSmith services available at <https://smith.langchain.com> and <https://eu.smith.langchain.com>.For information on the self-hosted LangSmith solution, please refer to the [self-hosted documentation](/langsmith/self-hosted).
